...
$num = $result->num_rows; //记录集的总条数   45


$pagesize = 15; //单个页面展示的数据条数 自定义每页的条数

$pagenum = ceil($num / $pagesize); //获取页数，一定选择向上取整。 5页
...
$page1->pagesize =  $pagenum; //将页数传递给实例对象
$page1->pagecontent = $arr;//将数据传递给实例对象
echo json_encode($page1);//接口返回总的页数和当页对应的数据。
